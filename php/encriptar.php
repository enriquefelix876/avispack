...
<?php
    ...
    //Generación de direcciones del usuario
    $sql6 = "select address from direccion where user_id = 2";
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php
        while($datos_pendientes=$query6->fetch_array()){
        ?>
            <section>
                <option value="">
                    <?php echo $datos_pendientes['address']?>
                </option>
            </section>
        <?php
        }
